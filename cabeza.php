...
$title = "Estudiar Diseño en Chile";
//Cambien el contenido de $description por el que corresponda a su sitio
$description = "Te invitamos a ver una serie de variables que permitirán evaluar
pros y contras, al momento de escoger tu lugar de estudio en el mundo del diseño.";
...
$image = "http://radio.uchile.cl/wp-content/uploads/2013/08/universidad.jpg";
?>
...
<?php if((basename($_SERVER['PHP_SELF']))=='ubicaciones.php'){?><script src="libs/sketch-profesores.js"></script><?php };?>
...
<li<?php if((basename($_SERVER['PHP_SELF']))=='index.php'){?> class="active" <?php };?>><a href="index.php">Grados y títulos</a></li>
...
<li<?php if((basename($_SERVER['PHP_SELF']))=='costos.php'){?> class="active" <?php };?>><a href="costos.php">Costo Aranceles</a></li>
